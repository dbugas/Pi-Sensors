...
class DPS310 {
    private:
        ...
        // Last compensated temperature value and flag to indicate if a temperature has been read
        float last_temperature_;
        double t_raw = 0.0;
    
        // Struct to hold calibration coefficients
        struct Coefficients {
        ...
        void checkMeasurementConstraint(int pressure_measurement_rate, int pressure_oversampling_rate,
            ...
            std::cout << "Measurement Constraint Check:\n"
    ...
    public:
        ...
        DPS310(int pressure_measurement_rate = 128, int pressure_oversampling_rate = 16,
            ...
            // We need to enable shifting if either pressure or temperature requires it
